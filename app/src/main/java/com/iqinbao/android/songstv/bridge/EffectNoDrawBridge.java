package com.iqinbao.android.songstv.bridge;
...
import com.iqinbao.android.songstv.utils.Utils;
...
public class EffectNoDrawBridge extends OpenEffectBridge {
	 ...
	 */
	@Override
	public void flyWhiteBorder(final View focusView, View moveView, final float scaleX, final float scaleY) {
