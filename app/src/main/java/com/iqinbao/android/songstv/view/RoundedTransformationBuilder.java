...
public final class RoundedTransformationBuilder {
	 ...
	 */
	public RoundedTransformationBuilder cornerRadiusType(float radius,int type) {
	...
	public RoundedTransformationBuilder cornerRadius(float radius,float radius_bottom) {
		mCornerRadii[Corner.TOP_LEFT] = radius;
		mCornerRadii[Corner.TOP_RIGHT] = radius;
		mCornerRadii[Corner.BOTTOM_RIGHT] = radius_bottom;
		mCornerRadii[Corner.BOTTOM_LEFT] = radius_bottom;
		return this;
	}
	/**
	 ...
	 * @return the builder for chaining.
	 */
	public RoundedTransformationBuilder cornerRadiusDp(float radius,int type) {
		return cornerRadiusType(TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_DIP, radius, mDisplayMetrics),type);
	}
